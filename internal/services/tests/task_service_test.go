...
func TestTaskService_ValidationAndBusinessRules(t *testing.T) {
	...
	service := services.InitTaskService(authRepo, projectRepo, taskRepo, &stubUserStoryRepo{}, &stubAuditLogRepo{}, &stubCustomStatusRepo{}, nil, logger)
...
func TestTaskService_GetTasks_StatusValidation(t *testing.T) {
	...
	service := services.InitTaskService(authRepo, projectRepo, taskRepo, &stubUserStoryRepo{}, &stubAuditLogRepo{}, statusRepo, nil, zap.NewNop())
