...
var _ = responsedto.CustomStatusResponse{}
...
// @Success 201 {object} response.SuccessResponse{data=responsedto.CustomStatusResponse}
...
// @Security BearerAuth
// @Param project_id path string true "Project ID"
// @Success 200 {object} response.SuccessResponse{data=[]responsedto.CustomStatusResponse}
// @Failure 401 {object} response.ErrorResponse
// @Failure 403 {object} response.ErrorResponse
// @Failure 500 {object} response.ErrorResponse
