...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/github_com_ms-kanban-server_internal_handlers_dto_response.ProjectSummary"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "github_com_ms-kanban-server_internal_handlers_dto_response.ProjectSummary": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
